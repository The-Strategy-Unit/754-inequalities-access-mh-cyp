...
Data sources
Need:Public Health England Fingertips indicators - Children and Young People's Mental Health and Wellbeing indicators of need 
Demand: Referral and treatment data from MHSDS, IAPT and SUS data

Need:Demand ratio = Number of people referredor treated/Number of people predicted to suffer from certain mental health conditions

A low Need:Demand ratio indicators an area has high levels of unmet need 
A high Need:Demand ratio indicates an area is accessing/treating the number of people PHE predicts are in need of support.



### Emotional disorders:
```{r Emotional disorder bar chart - STP, echo = FALSE, message = FALSE, warning = FALSE}
demand_ratio_stp("emot_dis_ratio", "Emotional disorders - Need:demand ratio")
```

```{r Emotional disorder bar chart - CCG, echo = FALSE, message = FALSE, warning = FALSE}
demand_ratio_ccg("emot_dis_ratio", "Emotional disorders - Need:demand ratio")
```

```{r Emotional disorder map - STP, echo = FALSE, message = FALSE, warning = FALSE}
stp_map_funct_nat("emot_dis_ratio", "Emotional disorders in CYP - Need:demand ratio")
```

``` {r Emotional disorder - CCG, echo = FALSE, message = FALSE, warning = FALSE}
ccg_map_funct_nat("emot_dis_ratio", "Emotional disorders in CYP - Need:demand ratio")
```

```{r Emotional disorder scatter plot - STP, echo = FALSE, message = FALSE, warning = FALSE}
...
```{r Emotional disorder scatter plot - CCG, echo = FALSE, message = FALSE, warning = FALSE}
scatter_function_ratio_ccg("emot_dis_count_sum", "emot_dis_denom_sum", "emot_dis_value", "emot_dis_ratio", "n_emotional_dis",
                           "Emotion disorders in CYP - Need:demand ratio")
```


### Conduct disorders:
```{r Conduct disorder bar chart - STP, echo = FALSE, message = FALSE, warning = FALSE}
demand_ratio_stp("cond_ratio", "Conduct disorders - Need:demand ratio")
```

```{r Conduct disorder bar chart - CCG, echo = FALSE, message = FALSE, warning = FALSE}
demand_ratio_ccg("cond_ratio", "Conduct disorders - Need:demand ratio")
```

```{r Conduct disorder map - STP, echo = FALSE, message = FALSE, warning = FALSE}
stp_map_funct_nat("cond_ratio", "Conduct disorders in CYP - Need:demand ratio")
```

```{r Conduct disorder map - CCG, echo = FALSE, message = FALSE, warning = FALSE}
ccg_map_funct_nat("cond_ratio", "Conduct disorders in CYP - Need:demand ratio")
```

```{r Conduct disorder scatter plot - STP, echo = FALSE, message = FALSE, warning = FALSE}
...
```{r Conduct disorder scatter plot - CCG, echo = FALSE, message = FALSE, warning = FALSE}
...
```{r Hyperkinetic disorder bar chart - STP, echo = FALSE, message = FALSE, warning = FALSE}
demand_ratio_stp("hyperkin_ratio", "Hyperkinetic disorders - Need:demand ratio")
```

```{r Hyperkinetic disorder bar chart - CCG, echo = FALSE, message = FALSE, warning = FALSE}
demand_ratio_ccg("hyperkin_ratio", "Hyperkinetic disorders - Need:demand ratio")
```

```{r Hyperkinetic disorder map - STP, echo = FALSE, message = FALSE, warning = FALSE}
stp_map_funct_nat("hyperkin_ratio", "Hyperkinetic disorders in CYP - Need:demand ratio")
```

``` {r Hyperkinetic disorder - CCG, echo = FALSE, message = FALSE, warning = FALSE}
ccg_map_funct_nat("hyperkin_ratio", "Hyperkinetic disorders in CYP - Need:demand ratio")
```

```{r Hyperkinetic disorder scatter plot - STP, echo = FALSE, message = FALSE, warning = FALSE}
...
```{r Hyperkinetic disorder scatter plot - CCG, echo = FALSE, message = FALSE, warning = FALSE}
...
### Self harm:
```{r Self harm bar chart - STP, echo = FALSE, message = FALSE, warning = FALSE}
demand_ratio_stp("self_harm_ratio", "Self harm - Need:demand ratio")
```

```{r Self harm bar chart - CCG, echo = FALSE, message = FALSE, warning = FALSE}
demand_ratio_ccg("self_harm_ratio", "Self harm - Need:demand ratio")
```

```{r Self harm map - STP, echo = FALSE, message = FALSE, warning = FALSE}
stp_map_funct_nat("self_harm_ratio", "Self harm in CYP - Need:demand ratio")
```

``` {r Self harm map - CCG, echo = FALSE, message = FALSE, warning = FALSE}
ccg_map_funct_nat("self_harm_ratio", "Self harm in CYP - Need:demand ratio")
```

```{r Self harm scatter plot - STP, echo = FALSE, message = FALSE, warning = FALSE}
...
```{r Self harm scatter plot - CCG, echo = FALSE, message = FALSE, warning = FALSE}
